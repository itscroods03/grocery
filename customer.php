				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" placeholder="Enter customer's name"class="form-control" name="name">
							</div>
							<div class="form-group">
								<label class="control-label">Contact no. </label>
								<input type="number" placeholder="Enter customer's contact no." class="form-control" name="contact">
							</div>
							<div class="form-group">
								<label class="control-label">Address</label>
								<textarea placeholder="Enter customer's address" class="form-control" cols="30" rows="3" name="address"></textarea>
							</div>
