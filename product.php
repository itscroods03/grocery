				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Stock Keeping Unit</label>
						...
						<div class="form-group">
							...
							<input type="text" placeholder="Enter product's name"class="form-control" name="name" >
						</div>
						<div class="form-group">
							<label class="control-label">Description</label>
							<textarea placeholder="Enter product's description"class="form-control" cols="30" rows="3" name="description"></textarea>
						</div>
						<div class="form-group">
							<label class="control-label">Product Price</label>
							<input placeholder="Enter product's price"type="number" step="any" class="form-control text-right" name="price" >
						</div>		
					</div>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>Stock Keeping Unit : <b><?php echo $row['sku'] ?></b></p>
